...
def _original_plus2c_audit_log_model():
    import json
    from pathlib import Path
    try:
        return json.loads(Path("13_web_dashboard/dist/original_plus2c_audit_log_model.json").read_text(encoding="utf-8"))
    except Exception:
        return {}

def _original_plus2d_approval_gate_model():
    import json
    from pathlib import Path
    try:
        return json.loads(Path("13_web_dashboard/dist/original_plus2d_approval_gate_model.json").read_text(encoding="utf-8"))
    except Exception:
        return {}
