...
def main():
    ...
    ensure(STATION_CHIEF_RUNTIME_VERSION == "9.0.0", f"Runtime version must be 9.0.0, got {STATION_CHIEF_RUNTIME_VERSION}")
    ensure(STABLE_RUNTIME_VERSION == "9.0.0", f"Release lock version must be 9.0.0, got {STABLE_RUNTIME_VERSION}")
    ensure(ADAPTER_MODULE_VERSION == "9.0.0", f"Adapter version must be 9.0.0, got {ADAPTER_MODULE_VERSION}")
    ...
    forbidden_globs = ["*v9_1*", "*v9.1*", "*v10*", "*v11*", "*v12*", "*v13*", "*v14*", "*v15*"]
