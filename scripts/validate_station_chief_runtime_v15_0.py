...
def main():
    ...
    # Versions
    check_file_content(runtime_dir / "station_chief_runtime.py", r'STATION_CHIEF_RUNTIME_VERSION\s*=\s*"(15\.0\.0|16\.0\.0|17\.0\.0|18\.0\.0|19\.0\.0)"', "Runtime version not 15.0.0, 16.0.0, 17.0.0, 18.0.0, or 19.0.0")
    check_file_content(runtime_dir / "station_chief_release_lock.py", r'STABLE_RUNTIME_VERSION\s*=\s*"(15\.0\.0|16\.0\.0|17\.0\.0|18\.0\.0|19\.0\.0)"', "Release lock not 15.0.0, 16.0.0, 17.0.0, 18.0.0, or 19.0.0")
    check_file_content(runtime_dir / "station_chief_adapters.py", r'ADAPTER_MODULE_VERSION\s*=\s*"(15\.0\.0|16\.0\.0|17\.0\.0|18\.0\.0|19\.0\.0)"', "Adapter version not 15.0.0, 16.0.0, 17.0.0, 18.0.0, or 19.0.0")

    # Future files
    ensure(not list(root_dir.rglob("*v15_1*")), "v15.1 files exist")
    ensure(not list(root_dir.rglob("*v15.1*")), "v15.1 files exist")
    ensure(not (list(root_dir.rglob("*v16_1*")) or list(root_dir.rglob("*v16.1*")) or list(root_dir.rglob("*v17_1*")) or list(root_dir.rglob("*v17.1*")) or list(root_dir.rglob("*v18_1*")) or list(root_dir.rglob("*v18.1*")) or (list(root_dir.rglob("*v19_1*")) or list(root_dir.rglob("*v19.1*")) or list(root_dir.rglob("*v20*")))), "Future files exist")
