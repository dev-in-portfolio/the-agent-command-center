...
def main():
    required_files = [
        UI_MODEL_DIR / "guided_product_demo_control_room_model.json",
        UI_MODEL_DIR / "demo_persona_path_model.json",
        UI_MODEL_DIR / "demo_storyline_model.json",
        UI_MODEL_DIR / "demo_readiness_scorecard_model.json",
        DIST_DIR / "mvp29_guided_product_demo_control_room_model.json",
        REPORT_DIR / "mvp29_guided_demo_control_room_report.md",
        REPORT_DIR / "mvp29_demo_persona_paths_report.md",
        REPORT_DIR / "mvp29_demo_storyline_report.md",
        REPORT_DIR / "mvp29_demo_readiness_scorecard_report.md",
        REPORT_DIR / "mvp29_security_boundary_report.md",
        REPORT_DIR / "mvp29_next_product_step_report.md",
        REPORT_DIR / "mvp29_validator_quality_report.md",
        REPORT_DIR / "mvp29_acceptance_report.md",
        REPORT_DIR / "mvp29_validator_wall_review.md",
    ]
    for path in required_files:
        ensure_exists(path)

    acceptance = read_text(REPORT_DIR / "mvp29_acceptance_report.md")
    for marker in [
        "GUIDED_PRODUCT_DEMO_CONTROL_ROOM_READY",
    ...
    for path in [
        ...
        if "manual" not in content.lower():
            fail(f"Manual demo posture missing in {path}")
    ...
    print("MVP29_GUIDED_PRODUCT_DEMO_CONTROL_ROOM_VALIDATION_PASS")
