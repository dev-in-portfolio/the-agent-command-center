...
def ensure_changed_paths() -> None:
    ...
    unexpected = [p for p in changed_paths if p not in ALLOWED_CHANGED_PATHS and "v14" not in p and "v15" not in p and "v16" not in p and "v17" not in p and "v18" not in p and "v19" not in p and "v20" not in p and "v13" not in p and "validate_station_chief" not in p]
