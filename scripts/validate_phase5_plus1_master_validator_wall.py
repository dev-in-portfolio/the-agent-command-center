...
mvp48_report_requirements = [
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_controlled_action_queue_report.md", "CONTROLLED_ACTION_QUEUE_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_action_queue_data_model_report.md", "ACTION_QUEUE_DATA_MODEL_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_queued_action_lifecycle_schema_report.md", "QUEUED_ACTION_LIFECYCLE_SCHEMA_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_queue_admission_gate_contract_report.md", "QUEUE_ADMISSION_GATE_CONTRACT_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_queue_priority_scheduling_model_report.md", "QUEUE_PRIORITY_SCHEDULING_MODEL_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_queue_hold_release_cancel_schema_report.md", "QUEUE_HOLD_RELEASE_CANCEL_SCHEMA_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_queue_dependency_precondition_model_report.md", "QUEUE_DEPENDENCY_PRECONDITION_MODEL_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_queue_audit_linkage_blueprint_report.md", "QUEUE_AUDIT_LINKAGE_BLUEPRINT_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_queue_operator_review_packet_report.md", "QUEUE_OPERATOR_REVIEW_PACKET_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_security_boundary_report.md", "PASS"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_next_product_step_report.md", "NEXT_STEP_BUILD_HUMAN_APPROVED_INTERNAL_EXECUTION"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_validator_quality_report.md", "PASS"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_acceptance_report.md", "CONTROLLED_ACTION_QUEUE_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_validator_wall_review.md", "PASS"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp48_validation_stewardship_report.md", "TIER 1 and TIER 2"),
]
for path, marker in mvp48_report_requirements:
    check(path.exists(), f"missing MVP-48 report: {path.relative_to(ROOT)}")
    if path.exists():
...
mvp50_model_requirements = [
    ROOT / "14_backend" / "product_runtime" / "ui_models" / "monitoring_stack_readiness_model.json",
    ROOT / "14_backend" / "product_runtime" / "ui_models" / "alert_definition_model.json",
    ROOT / "14_backend" / "product_runtime" / "ui_models" / "incident_console_model.json",
    ROOT / "14_backend" / "product_runtime" / "ui_models" / "rollback_automation_model.json",
    ROOT / "14_backend" / "product_runtime" / "ui_models" / "incident_triage_model.json",
    ROOT / "14_backend" / "product_runtime" / "ui_models" / "runbook_automation_model.json",
    ROOT / "14_backend" / "product_runtime" / "ui_models" / "rollback_verification_model.json",
    ROOT / "14_backend" / "product_runtime" / "ui_models" / "monitoring_dashboard_model.json",
    ROOT / "14_backend" / "product_runtime" / "ui_models" / "incident_response_timeline_model.json",
    ROOT / "14_backend" / "product_runtime" / "ui_models" / "rollback_scope_analysis_model.json",
]
...
mvp50_release_requirements = [
    ROOT / "09_exports" / "release_package" / "mvp50_monitoring_stack_readiness.md",
    ROOT / "09_exports" / "release_package" / "mvp50_alert_definition.md",
    ROOT / "09_exports" / "release_package" / "mvp50_incident_console.md",
    ROOT / "09_exports" / "release_package" / "mvp50_rollback_automation.md",
    ROOT / "09_exports" / "release_package" / "mvp50_incident_triage.md",
    ROOT / "09_exports" / "release_package" / "mvp50_runbook_automation.md",
    ROOT / "09_exports" / "release_package" / "mvp50_rollback_verification.md",
    ROOT / "09_exports" / "release_package" / "mvp50_monitoring_dashboard.md",
    ROOT / "09_exports" / "release_package" / "mvp50_incident_response_timeline.md",
    ROOT / "09_exports" / "release_package" / "mvp50_rollback_scope_analysis.md",
    ROOT / "09_exports" / "release_package" / "mvp50_monitoring_stack_rollback_incident_console_manifest.json",
]
...
mvp50_report_requirements = [
    (ROOT / "09_exports" / "mvp_product_track" / "mvp50_monitoring_stack_rollback_incident_console_report.md", "MVP-50"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp50_alert_definition_report.md", "ALERT_DEFINITION_SCHEMA_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp50_incident_console_report.md", "INCIDENT_CONSOLE_MODEL_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp50_rollback_automation_report.md", "ROLLBACK_AUTOMATION_DEFINITION_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp50_incident_triage_report.md", "INCIDENT_TRIAGE_CLASSIFICATION_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp50_runbook_automation_report.md", "RUNBOOK_AUTOMATION_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp50_rollback_verification_report.md", "ROLLBACK_VERIFICATION_CHECKLIST_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp50_monitoring_dashboard_report.md", "MONITORING_DASHBOARD_LAYOUT_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp50_incident_response_timeline_report.md", "INCIDENT_RESPONSE_TIMELINE_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp50_rollback_scope_analysis_report.md", "ROLLBACK_SCOPE_ANALYSIS_READY"),
    ...
    (ROOT / "09_exports" / "mvp_product_track" / "mvp50_acceptance_report.md", "MONITORING_STACK_READINESS_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp50_validation_stewardship_report.md", "MONITORING_STACK_VALIDATION_READY"),
]
...
mvp47_report_requirements = [
    ...
    (ROOT / "09_exports" / "mvp_product_track" / "mvp47_preflight_validation_schema_report.md", "PREFLIGHT_VALIDATION_SCHEMA_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp47_simulated_execution_result_schema_report.md", "SIMULATED_EXECUTION_RESULT_SCHEMA_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp47_risk_dependency_report.md", "RISK_DEPENDENCY_REPORT_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp47_rollback_preview_report.md", "ROLLBACK_PREVIEW_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp47_approval_bound_dry_run_contract_report.md", "APPROVAL_BOUND_DRY_RUN_CONTRACT_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp47_dry_run_evidence_packet_report.md", "DRY_RUN_EVIDENCE_PACKET_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp47_security_boundary_report.md", "PASS"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp47_next_product_step_report.md", "NEXT_STEP_BUILD_CONTROLLED_ACTION_QUEUE"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp47_validator_quality_report.md", "PASS"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp47_acceptance_report.md", "SERVER_SIDE_DRY_RUN_ENGINE_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp47_validator_wall_review.md", "PASS"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp47_validation_stewardship_report.md", "TIER 1 and TIER 2"),
]
for path, marker in mvp47_report_requirements:
    check(path.exists(), f"missing MVP-47 report: {path.relative_to(ROOT)}")
    if path.exists():
        check(marker in path.read_text(encoding="utf-8", errors="replace"), f"MVP-47 report missing marker: {path.name}")

mvp46_report_requirements = [
    (ROOT / "09_exports" / "mvp_product_track" / "mvp46_approval_gate_storage_report.md", "APPROVAL_GATE_STORAGE_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp46_approval_request_schema_report.md", "APPROVAL_REQUEST_SCHEMA_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp46_approval_decision_schema_report.md", "APPROVAL_DECISION_SCHEMA_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp46_approval_scope_expiration_model_report.md", "APPROVAL_SCOPE_EXPIRATION_MODEL_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp46_approval_revocation_model_report.md", "APPROVAL_REVOCATION_MODEL_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp46_approval_audit_linkage_blueprint_report.md", "APPROVAL_AUDIT_LINKAGE_BLUEPRINT_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp46_approval_permission_boundary_contract_report.md", "APPROVAL_PERMISSION_BOUNDARY_CONTRACT_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp46_approval_storage_readiness_checklist_report.md", "APPROVAL_STORAGE_READINESS_CHECKLIST_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp46_security_boundary_report.md", "PASS"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp46_next_product_step_report.md", "NEXT_STEP_BUILD_SERVER_SIDE_DRY_RUN_ENGINE"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp46_validator_quality_report.md", "PASS"),
...
for path, marker in mvp46_report_requirements:
    ...
    if path.exists():
        check(marker in path.read_text(encoding="utf-8", errors="replace"), f"MVP-46 report missing marker: {path.name}")

mvp45_report_requirements = [
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_immutable_audit_event_ledger_report.md", "IMMUTABLE_AUDIT_EVENT_LEDGER_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_audit_event_data_model_report.md", "AUDIT_EVENT_DATA_MODEL_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_append_only_ledger_contract_report.md", "APPEND_ONLY_LEDGER_CONTRACT_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_audit_event_taxonomy_report.md", "AUDIT_EVENT_TAXONOMY_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_actor_action_resource_schema_report.md", "ACTOR_ACTION_RESOURCE_SCHEMA_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_before_after_snapshot_blueprint_report.md", "BEFORE_AFTER_SNAPSHOT_BLUEPRINT_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_audit_integrity_tamper_resistance_plan_report.md", "AUDIT_INTEGRITY_TAMPER_RESISTANCE_PLAN_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_audit_retention_export_blueprint_report.md", "AUDIT_RETENTION_EXPORT_BLUEPRINT_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_security_boundary_report.md", "PASS"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_next_product_step_report.md", "NEXT_STEP_BUILD_APPROVAL_GATE_STORAGE"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_validator_quality_report.md", "PASS"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_acceptance_report.md", "IMMUTABLE_AUDIT_EVENT_LEDGER_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_validator_wall_review.md", "PASS"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp45_validation_stewardship_report.md", "TIER 1 and TIER 2"),
]
for path, marker in mvp45_report_requirements:
    check(path.exists(), f"missing MVP-45 report: {path.relative_to(ROOT)}")
    if path.exists():
        check(marker in path.read_text(encoding="utf-8", errors="replace"), f"MVP-45 report missing marker: {path.name}")

mvp44_report_requirements = [
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_persistent_request_storage_foundation_report.md", "PERSISTENT_REQUEST_STORAGE_FOUNDATION_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_request_storage_data_model_report.md", "REQUEST_STORAGE_DATA_MODEL_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_request_lifecycle_state_model_report.md", "REQUEST_LIFECYCLE_STATE_MODEL_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_request_metadata_schema_report.md", "REQUEST_METADATA_SCHEMA_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_storage_boundary_contract_report.md", "STORAGE_BOUNDARY_CONTRACT_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_server_side_storage_access_plan_report.md", "SERVER_SIDE_STORAGE_ACCESS_PLAN_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_request_retrieval_readiness_plan_report.md", "REQUEST_RETRIEVAL_READINESS_PLAN_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_storage_migration_blueprint_report.md", "STORAGE_MIGRATION_BLUEPRINT_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_security_boundary_report.md", "PASS"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_next_product_step_report.md", "NEXT_STEP_BUILD_IMMUTABLE_AUDIT_EVENT_LEDGER"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_validator_quality_report.md", "PASS"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_acceptance_report.md", "PERSISTENT_REQUEST_STORAGE_FOUNDATION_READY"),
    (ROOT / "09_exports" / "mvp_product_track" / "mvp44_validator_wall_review.md", "PASS"),
]
for path, marker in mvp44_report_requirements:
    check(path.exists(), f"missing MVP-44 report: {path.relative_to(ROOT)}")
    if path.exists():
        check(marker in path.read_text(encoding="utf-8", errors="replace"), f"MVP-44 report missing marker: {path.name}")
