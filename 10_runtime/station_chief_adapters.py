...
SUPPORTED_ADAPTERS = {
    "noop": {
        ...
        "allowlisted_file_hashing_allowed": True,
                "supports_station_chief_v19_multi_agent_live_work_router": True,
        "supports_station_chief_v20_operational_agent_army_mode": True,
        "supports_station_chief_v21_controlled_local_workspace_artifact_factory": True,
        "supports_station_chief_v22_controlled_business_workflow_workpack": True,
        "station_chief_v22_controlled_business_workflow_allowed": True,
        "client_ready_workpack_factory_allowed": True,
        "business_workflow_type_registry_allowed": True,
        "workflow_type_count_5_allowed": True,
        "executable_workflow_type_count_1_allowed": True,
        "controlled_action_count_7_allowed": True,
        "controlled_business_artifact_count_6_allowed": True,
        "logical_agent_role_count_6_allowed": True,
        "routed_v21_v20_v19_v18_v17_operational_chain_allowed": True,
        "controlled_project_brief_markdown_write_allowed": True,
        "controlled_execution_plan_json_write_allowed": True,
        "controlled_tracker_csv_write_allowed": True,
        "controlled_client_ready_summary_markdown_write_allowed": True,
        "controlled_qa_checklist_markdown_write_allowed": True,
        "controlled_business_manifest_json_write_allowed": True,
        "controlled_business_workspace_path_required": True,
        ...
        "repo_file_write_allowed": False,
        "repo_mutation_allowed": False,
        "human_approval_required": True,
        "approval_phrase_required": True,
        "business_workflow_receipt_required": True,
        "business_workflow_audit_required": True,
        "station_chief_v21_controlled_local_workspace_allowed": True,
        "artifact_factory_workpack_execution_allowed": True,
        "controlled_action_count_5_allowed": True,
        "controlled_artifact_count_4_allowed": True,
        "logical_agent_role_count_6_allowed": True,
        "routed_v20_v19_v18_v17_operational_chain_allowed": True,
        "controlled_json_artifact_write_allowed": True,
        "controlled_markdown_artifact_write_allowed": True,
        "controlled_csv_artifact_write_allowed": True,
        "controlled_artifact_manifest_write_allowed": True,
        "controlled_local_workspace_path_required": True,
        "binary_document_generation_allowed": False,
        "binary_spreadsheet_generation_allowed": False,
        "repo_file_write_allowed": False,
        "repo_mutation_allowed": False,
        "human_approval_required": True,
        "approval_phrase_required": True,
        "artifact_factory_receipt_required": True,
        "artifact_factory_audit_required": True,
        "station_chief_v20_operational_agent_army_mode_allowed": True,
        "operational_workpack_execution_allowed": True,
        "controlled_action_count_2_allowed": True,
        "logical_agent_role_count_6_allowed": True,
        "routed_v19_v18_v17_readonly_inspection_allowed": True,
        "controlled_temp_sandbox_artifact_write_allowed": True,
        "controlled_temp_sandbox_path_required": True,
        "repo_file_write_allowed": False,
        "repo_mutation_allowed": False,
        "human_approval_required": True,
        "approval_phrase_required": True,
        "operational_receipt_required": True,
        "operational_audit_required": True,
        "station_chief_v19_multi_agent_live_work_router_allowed": True,
        "logical_agent_squad_registry_allowed": True,
        "agent_role_count_6_allowed": True,
        "supervised_live_task_packet_allowed": True,
        "agent_assignment_matrix_allowed": True,
        "live_work_routing_decision_allowed": True,
        "supervised_dispatch_plan_allowed": True,
        "agent_handoff_receipt_ledger_allowed": True,
        "final_routed_work_receipt_allowed": True,
        "routed_v18_controlled_adapter_execution_allowed": True,
        "human_approval_required": True,
        "approval_phrase_required": True,
        "logical_agent_routing_allowed": True,
        "real_worker_process_start_allowed": False,
        "background_agent_start_allowed": False,
...
def list_adapters() -> dict:
    return {
        ...
        "v22_1_creation_allowed": False,
        "v23_creation_allowed": False,
