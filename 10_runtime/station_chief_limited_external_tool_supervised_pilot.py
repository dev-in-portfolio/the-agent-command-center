...
def generate_limited_external_tool_supervised_pilot_id(
    ...
    return f"limited-external-tool-supervised-pilot-v3-3-{normalized_tool_pilot_label}-{digest}"
...
def create_limited_external_tool_supervised_pilot_approval_gate(
    ...
    return {
        "limited_external_tool_supervised_pilot_approval_gate_version": "3.3.0",
...
def create_single_external_tool_category_contract(
    ...
    return {
        "single_external_tool_category_contract_version": "3.3.0",
...
def create_tool_invocation_denial_by_default(
    ...
    return {
        "tool_invocation_denial_by_default_version": "3.3.0",
...
def create_human_tool_use_preflight_gate(
    ...
    return {
        "human_tool_use_preflight_gate_version": "3.3.0",
...
def create_tool_request_envelope_preview(
    ...
    return {
        "tool_request_envelope_preview_version": "3.3.0",
...
def create_tool_response_quarantine_preview(
    ...
    return {
        "tool_response_quarantine_preview_version": "3.3.0",
...
def create_tool_audit_proof(
    ...
    return {
        "tool_audit_proof_version": "3.3.0",
...
def create_tool_pilot_ledger(
    ...
    return {
        "tool_pilot_ledger_version": "3.3.0",
...
def create_tool_pilot_readiness_summary(
    ...
    return {
        "tool_pilot_readiness_summary_version": "3.3.0",
...
def create_supervised_external_api_pilot_bridge(
    ...
    return {
        "supervised_external_api_pilot_bridge_version": "3.3.0",
...
def create_limited_external_tool_supervised_pilot_bundle(
    ...
    return {
        "limited_external_tool_supervised_pilot_bundle_version": "3.3.0",
