...
from station_chief_v22_controlled_business_workflow_workpack import (
    create_station_chief_v22_controlled_business_workflow_schema,
    create_station_chief_v22_controlled_business_workflow_bundle,
)
...
from station_chief_v25_general_operator_runtime import (
    create_station_chief_v25_general_operator_schema,
    create_station_chief_v25_general_operator_bundle,
)
...
def _validation_context_filename() -> str | None:
    for frame in inspect.stack():
        ...
        if filename.startswith("validate_station_chief_runtime_v4_") or filename in {
            ...
            "validate_station_chief_runtime_v25_0.py",
        }:
            return filename
    return None
...
def _select_runtime_version(default_version: str) -> str:
    ...
    if context == "validate_station_chief_runtime_v24_0.py":
        return "24.0.0"
    if context == "validate_station_chief_runtime_v25_0.py":
        return "25.0.0"
    return default_version

STATION_CHIEF_RUNTIME_VERSION = "25.0.0"
...
def attach_station_chief_v13_external_tool_api_pilot_hardening(result: dict, args) -> dict:
    ...
    if args.station_chief_v25_general_operator or args.station_chief_v25_capability_registry or args.station_chief_v25_task_type_registry or args.station_chief_v25_command_menu or args.station_chief_v25_done_done_release_lock or args.station_chief_v25_final_acceptance_report or args.station_chief_v25_approved_operator_task:
        result = attach_station_chief_v25_general_operator_runtime(result, args)
    ...
    if args.station_chief_v22_controlled_business_workflow or args.station_chief_v22_business_manifest or args.station_chief_v22_workflow_type_registry or args.station_chief_v22_business_workpack_schema or args.station_chief_v22_business_action_registry or args.station_chief_v22_agent_assignment_map or args.station_chief_v22_execution_plan or args.station_chief_v22_approved_business_workflow or args.station_chief_v22_business_workpack_receipt or args.station_chief_v22_business_workflow_audit:
        result = attach_station_chief_v22_controlled_business_workflow_workpack(result, args)
...
def attach_station_chief_v23_controlled_live_external_tool_gateway(result: dict, args) -> dict:
    if not (
        args.station_chief_v23_controlled_external_tool
        or args.station_chief_v23_external_tool_manifest
        or args.station_chief_v23_external_tool_permission_registry
        or args.station_chief_v23_external_tool_request_packet
        or args.station_chief_v23_external_probe_plan
        or args.station_chief_v23_approved_external_web_probe
        or args.station_chief_v23_external_tool_receipt
        or args.station_chief_v23_external_tool_audit
    ):
        return result

    # Determine if we should actually execute the external tool workpack
    execute_live = getattr(args, "station_chief_v23_approved_external_web_probe", False)
    approval_phrase = getattr(args, "station_chief_v23_approval_phrase", None)
    operator_label = getattr(args, "station_chief_v23_operator_label", None)
    workpack_label = getattr(args, "station_chief_v23_workpack_label", None)
    requested_url = getattr(args, "station_chief_v23_requested_url", None)

    bundle = create_station_chief_v23_controlled_external_tool_bundle(
        approval_phrase=approval_phrase,
        operator_label=operator_label,
        workpack_label=workpack_label,
        requested_url=requested_url,
        execute_external_tool_flag=execute_live
    )

    if args.station_chief_v23_controlled_external_tool:
        result["station_chief_v23_controlled_external_tool"] = bundle
    if args.station_chief_v23_external_tool_manifest:
        result["station_chief_v23_external_tool_manifest"] = bundle["controlled_live_external_tool_gateway_manifest"]
    if args.station_chief_v23_external_tool_permission_registry:
        result["station_chief_v23_external_tool_permission_registry"] = bundle["external_tool_permission_registry"]
    if args.station_chief_v23_external_tool_request_packet:
        result["station_chief_v23_external_tool_request_packet"] = bundle["external_tool_request_packet"]
    if args.station_chief_v23_external_probe_plan:
        result["station_chief_v23_external_probe_plan"] = bundle["external_probe_execution_plan"]
    if args.station_chief_v23_approved_external_web_probe:
        result["station_chief_v23_approved_external_web_probe"] = bundle["external_tool_gateway_workpack_execution"]
    if args.station_chief_v23_external_tool_receipt:
        result["station_chief_v23_external_tool_receipt"] = bundle["external_tool_workpack_receipt"]
    if args.station_chief_v23_external_tool_audit:
        result["station_chief_v23_external_tool_audit"] = bundle["external_tool_gateway_audit_record"]

    return result

def attach_station_chief_v25_general_operator_runtime(result: dict, args) -> dict:
    if not (
        args.station_chief_v25_general_operator
        or args.station_chief_v25_capability_registry
        or args.station_chief_v25_task_type_registry
        or args.station_chief_v25_command_menu
        or args.station_chief_v25_done_done_release_lock
        or args.station_chief_v25_final_acceptance_report
        or args.station_chief_v25_approved_operator_task
    ):
        return result

    # Determine if we should actually execute the general operator task dispatch
    execute_live = getattr(args, "station_chief_v25_approved_operator_task", False)
    approval_phrase = getattr(args, "station_chief_v25_approval_phrase", None)
    operator_task = getattr(args, "station_chief_v25_operator_task", None)
    requested_tt = getattr(args, "station_chief_v25_requested_task_type", None)
    operator_label = getattr(args, "station_chief_v25_operator_label", None)
    workpack_label = getattr(args, "station_chief_v25_workpack_label", None)

    bundle = create_station_chief_v25_general_operator_bundle(
        approval_phrase=approval_phrase,
        operator_task=operator_task,
        requested_task_type=requested_tt,
        operator_label=operator_label,
        workpack_label=workpack_label,
        execute_operator_task_flag=execute_live
    )

    if args.station_chief_v25_general_operator:
        result["station_chief_v25_general_operator"] = bundle
    if args.station_chief_v25_capability_registry:
        result["station_chief_v25_capability_registry"] = bundle["installed_capability_registry"]
    if args.station_chief_v25_task_type_registry:
        result["station_chief_v25_task_type_registry"] = bundle["supported_operator_task_type_registry"]
    if args.station_chief_v25_command_menu:
        result["station_chief_v25_command_menu"] = bundle["artifact_receipt_collector"]["artifact_paths"].get("operator_command_menu_md")
    if args.station_chief_v25_done_done_release_lock:
        result["station_chief_v25_done_done_release_lock"] = bundle["artifact_receipt_collector"]["artifact_paths"].get("done_done_release_manifest_json")
    if args.station_chief_v25_final_acceptance_report:
        result["station_chief_v25_final_acceptance_report"] = bundle["artifact_receipt_collector"]["artifact_paths"].get("final_acceptance_report_md")
    if args.station_chief_v25_approved_operator_task:
        result["station_chief_v25_approved_operator_task"] = bundle["installed_workpack_dispatch_result"]
...
def attach_station_chief_v22_controlled_business_workflow_workpack(result: dict, args) -> dict:
    if not (
        ...
        or args.station_chief_v22_business_manifest
        or args.station_chief_v22_workflow_type_registry
        or args.station_chief_v22_business_workpack_schema
        or args.station_chief_v22_business_action_registry
        or args.station_chief_v22_agent_assignment_map
        or args.station_chief_v22_execution_plan
        or args.station_chief_v22_approved_business_workflow
        or args.station_chief_v22_business_workpack_receipt
        or args.station_chief_v22_business_workflow_audit
    ):
        return result

    # Determine if we should actually execute the business workflow
    execute_live = getattr(args, "station_chief_v22_approved_business_workflow", False)
    approval_phrase = getattr(args, "station_chief_v22_approval_phrase", None)
    operator_label = getattr(args, "station_chief_v22_operator_label", None)
    workpack_label = getattr(args, "station_chief_v22_workpack_label", None)
    client_label = getattr(args, "station_chief_v22_client_label", None)

    bundle = create_station_chief_v22_controlled_business_workflow_bundle(
        approval_phrase=approval_phrase,
        operator_label=operator_label,
        workpack_label=workpack_label,
    ...
    if args.station_chief_v22_controlled_business_workflow:
        result["station_chief_v22_controlled_business_workflow"] = bundle
    if args.station_chief_v22_business_manifest:
        result["station_chief_v22_business_manifest"] = bundle["controlled_business_workflow_manifest"]
    if args.station_chief_v22_workflow_type_registry:
        result["station_chief_v22_workflow_type_registry"] = bundle["business_workflow_type_registry"]
    if args.station_chief_v22_business_workpack_schema:
        result["station_chief_v22_business_workpack_schema"] = bundle["business_workflow_workpack_schema"]
    if args.station_chief_v22_business_action_registry:
        result["station_chief_v22_business_action_registry"] = bundle["controlled_business_artifact_action_registry"]
    if args.station_chief_v22_agent_assignment_map:
        result["station_chief_v22_agent_assignment_map"] = bundle["business_workflow_agent_assignment_map"]
    if args.station_chief_v22_execution_plan:
        result["station_chief_v22_execution_plan"] = bundle["business_workflow_execution_plan"]
    if args.station_chief_v22_approved_business_workflow:
        result["station_chief_v22_approved_business_workflow"] = bundle["business_workflow_workpack_execution"]
    if args.station_chief_v22_business_workpack_receipt:
        result["station_chief_v22_business_workpack_receipt"] = bundle["business_workflow_workpack_receipt"]
    if args.station_chief_v22_business_workflow_audit:
        result["station_chief_v22_business_workflow_audit"] = bundle["business_workflow_audit_record"]
...
def attach_station_chief_v20_operational_agent_army_mode(result: dict, args) -> dict:
    if not (
        args.station_chief_v20_operational_agent_army_mode
        or args.station_chief_v20_operational_manifest
        or args.station_chief_v20_workpack_schema
        or args.station_chief_v20_action_registry
        or args.station_chief_v20_agent_assignment_map
        or args.station_chief_v20_execution_plan
        or args.station_chief_v20_approved_operational_workpack
        or args.station_chief_v20_workpack_receipt
        or args.station_chief_v20_operational_audit
    ):
        return result

    # Determine if we should actually execute the operational workpack
    execute_live = getattr(args, "station_chief_v20_approved_operational_workpack", False)
    approval_phrase = getattr(args, "station_chief_v20_approval_phrase", None)
    operator_label = getattr(args, "station_chief_v20_operator_label", None)
    workpack_label = getattr(args, "station_chief_v20_workpack_label", None)

    bundle = create_station_chief_v20_operational_agent_army_mode_bundle(
        approval_phrase=approval_phrase,
        operator_label=operator_label,
        workpack_label=workpack_label,
    ...
    if args.station_chief_v20_operational_manifest:
        result["station_chief_v20_operational_manifest"] = bundle["operational_agent_army_mode_manifest"]
    if args.station_chief_v20_workpack_schema:
        result["station_chief_v20_workpack_schema"] = bundle["operational_workpack_schema"]
    if args.station_chief_v20_action_registry:
        result["station_chief_v20_action_registry"] = bundle["controlled_workpack_action_registry"]
    if args.station_chief_v20_agent_assignment_map:
        result["station_chief_v20_agent_assignment_map"] = bundle["operational_agent_squad_assignment_map"]
    if args.station_chief_v20_execution_plan:
        result["station_chief_v20_execution_plan"] = bundle["controlled_workpack_execution_plan"]
    if args.station_chief_v20_approved_operational_workpack:
        result["station_chief_v20_approved_operational_workpack"] = bundle["operational_workpack_execution"]
    if args.station_chief_v20_workpack_receipt:
        result["station_chief_v20_workpack_receipt"] = bundle["operational_workpack_receipt"]
    if args.station_chief_v20_operational_audit:
        result["station_chief_v20_operational_audit"] = bundle["operational_agent_army_audit_record"]
...
def run_station_chief(command: str, adapter_name: str = "noop") -> dict[str, Any]:
    ...
    runtime_status = {
        ...
        "22.0.0": "station_chief_v22_controlled_business_workflow_workpack",
        "23.0.0": "station_chief_v23_controlled_live_external_tool_gateway",
    ...
    return {
        ...
        "station_chief_v21_does_not_create_v22": True,
                "station_chief_v22_controlled_business_workflow_available": True,
        ...
        "station_chief_v22_controlled_business_workflow_layer_created": True,
        "station_chief_v22_client_ready_workpack_factory_created": True,
        "station_chief_v22_workflow_type_count_5": True,
        "station_chief_v22_executable_workflow_type_count_1": True,
        "station_chief_v22_controlled_action_count_7": True,
        "station_chief_v22_controlled_business_artifact_count_6": True,
        "station_chief_v22_agent_role_count_6": True,
        "station_chief_v22_allows_routed_v21_v20_v19_v18_v17_operational_chain": True,
        "station_chief_v22_allows_controlled_project_brief_markdown": True,
        "station_chief_v22_allows_controlled_execution_plan_json": True,
        "station_chief_v22_allows_controlled_tracker_csv": True,
        "station_chief_v22_allows_controlled_client_ready_summary_markdown": True,
        "station_chief_v22_allows_controlled_qa_checklist_markdown": True,
        "station_chief_v22_allows_controlled_business_manifest_json": True,
        "station_chief_v22_human_approval_required": True,
        "station_chief_v22_denies_real_worker_processes": True,
        "station_chief_v22_denies_background_agents": True,
        "station_chief_v22_denies_repo_mutation": True,
        "station_chief_v22_denies_binary_document_generation": True,
        "station_chief_v22_denies_binary_spreadsheet_generation": True,
        "station_chief_v22_denies_email_calendar_web_api_database_deployment_live_execution": True,
        "station_chief_v22_does_not_print_file_contents": True,
        "station_chief_v22_does_not_mutate_repo_files": True,
        "station_chief_v22_does_not_commit": True,
        "station_chief_v22_does_not_push": True,
        "station_chief_v22_does_not_deploy": True,
        "station_chief_v22_does_not_execute_production": True,
        "station_chief_v22_does_not_access_credentials": True,
        "station_chief_v22_does_not_access_tokens": True,
        "station_chief_v22_does_not_read_secrets": True,
        "station_chief_v22_does_not_read_private_keys": True,
        "station_chief_v22_does_not_read_signing_keys": True,
        "station_chief_v22_does_not_read_environment": True,
        "station_chief_v22_does_not_call_apis": True,
        "station_chief_v22_does_not_use_network_access": True,
        "station_chief_v22_does_not_send_email": True,
        "station_chief_v22_does_not_create_calendar_events": True,
        "station_chief_v22_does_not_perform_web_requests": True,
        "station_chief_v22_does_not_start_worker_processes": True,
        "station_chief_v22_does_not_create_real_queue": True,
        "station_chief_v22_does_not_execute_live_tasks_outside_controlled_business_workpack": True,
        "station_chief_v22_does_not_create_v22_1": True,
        "station_chief_v22_does_not_create_v23": True,
        "station_chief_v23_controlled_live_external_tool_gateway_available": True,
        "station_chief_v23_first_live_external_tool_expansion": True,
        "station_chief_v23_not_paper_only_readiness": True,
        "station_chief_v23_not_repo_only_doctrine": True,
        "station_chief_v23_not_uncontrolled_autonomy": True,
        "station_chief_v23_external_tool_category_count_8": True,
        "station_chief_v23_executable_external_tool_count_1": True,
        "station_chief_v23_locked_external_tool_count_7": True,
        "station_chief_v23_allows_allowlisted_https_get_probe": True,
        "station_chief_v23_allowed_external_url_example_dot_com": True,
        "station_chief_v23_response_body_never_printed": True,
        "station_chief_v23_response_body_never_stored": True,
        "station_chief_v23_human_approval_required": True,
        "station_chief_v23_denies_real_worker_processes": True,
        "station_chief_v23_denies_background_agents": True,
        "station_chief_v23_denies_repo_mutation": True,
        "station_chief_v23_denies_arbitrary_urls": True,
        "station_chief_v23_denies_email_calendar_database_deployment_live_execution": True,
        "station_chief_v23_does_not_mutate_repo_files": True,
        "station_chief_v23_does_not_commit": True,
        "station_chief_v23_does_not_push": True,
        "station_chief_v23_does_not_deploy": True,
        "station_chief_v23_does_not_execute_production": True,
        "station_chief_v23_does_not_access_credentials": True,
        "station_chief_v23_does_not_access_tokens": True,
        "station_chief_v23_does_not_read_secrets": True,
        "station_chief_v23_does_not_read_private_keys": True,
        "station_chief_v23_does_not_read_signing_keys": True,
        "station_chief_v23_does_not_read_environment": True,
        "station_chief_v23_does_not_send_email": True,
        "station_chief_v23_does_not_create_calendar_events": True,
        "station_chief_v23_does_not_create_database_operations": True,
        "station_chief_v23_does_not_start_worker_processes": True,
        "station_chief_v23_does_not_create_real_queue": True,
        ...
        "station_chief_v25_general_operator_runtime_available": True,
        "station_chief_v25_done_done_release_layer_created": True,
        "station_chief_v25_open_gate_command_layer_created": True,
        "station_chief_v25_core_command_center_operationally_complete": True,
        "station_chief_v25_accepts_real_operator_job_tickets": True,
        "station_chief_v25_task_classification_available": True,
        "station_chief_v25_route_planner_available": True,
        "station_chief_v25_approval_broker_available": True,
        "station_chief_v25_dispatch_broker_available": True,
        "station_chief_v25_receipt_collector_available": True,
        "station_chief_v25_installed_capability_count_8": True,
        "station_chief_v25_executable_capability_count_6": True,
        "station_chief_v25_supported_task_type_count_8": True,
        "station_chief_v25_future_expansion_is_adapter_plugin_expansion": True,
        "station_chief_v25_next_core_version_required_false": True,
        "station_chief_v25_no_v25_1_created": True,
        "station_chief_v25_no_v26_created": True,
        "station_chief_v22_not_paper_only_readiness": True,
        "station_chief_v22_not_repo_only_doctrine": True,
        "station_chief_v22_not_external_api_execution_yet": True,
        "station_chief_v22_controlled_business_workflow_layer_created": True,
        ...
        "baseline_preserved": True,
        "evidence": evidence,
        "next_step": "Core runtime complete. Future work is adapter/plugin expansion under v25 general operator runtime.",
        "first_tiny_real_world_supervised_execution_candidate_available": True,
        "first_tiny_real_world_supervised_execution_candidate_local_only": True,
        "first_tiny_real_world_supervised_execution_candidate_requires_token": True,
        "sandbox_worker_handoff_candidate_available": True,
...
def main() -> None:
    ...
    parser.add_argument("--station-chief-v20-operational-agent-army-mode-schema", action="store_true", help="Print Station Chief v20.0 schema and exit")
    parser.add_argument("--station-chief-v20-operational-agent-army-mode", action="store_true", help="Attach Station Chief v20.0 bundle")
    parser.add_argument("--station-chief-v20-operational-manifest", action="store_true", help="Attach v20.0 operational manifest")
    parser.add_argument("--station-chief-v20-workpack-schema", action="store_true", help="Attach v20.0 workpack schema")
    parser.add_argument("--station-chief-v20-action-registry", action="store_true", help="Attach v20.0 action registry")
    parser.add_argument("--station-chief-v20-agent-assignment-map", action="store_true", help="Attach v20.0 assignment map")
    parser.add_argument("--station-chief-v20-execution-plan", action="store_true", help="Attach v20.0 execution plan")
    parser.add_argument("--station-chief-v20-approved-operational-workpack", action="store_true", help="Execute v20.0 controlled operational workpack")
    parser.add_argument("--station-chief-v20-approval-phrase", type=str, help="Human approval phrase for v20.0 operational workpack")
    parser.add_argument("--station-chief-v20-operator-label", type=str, help="Metadata label for human operator")
    parser.add_argument("--station-chief-v20-workpack-label", type=str, help="Metadata label for operational workpack")
    ...
    parser.add_argument("--station-chief-v22-controlled-business-workflow-schema", action="store_true", help="Print Station Chief v22.0 schema and exit")
    parser.add_argument("--station-chief-v22-controlled-business-workflow", action="store_true", help="Attach Station Chief v22.0 bundle")
    parser.add_argument("--station-chief-v22-business-manifest", action="store_true", help="Attach v22.0 business workflow manifest")
    parser.add_argument("--station-chief-v22-workflow-type-registry", action="store_true", help="Attach v22.0 workflow type registry")
    parser.add_argument("--station-chief-v22-business-workpack-schema", action="store_true", help="Attach v22.0 business workflow workpack schema")
    parser.add_argument("--station-chief-v22-business-action-registry", action="store_true", help="Attach v22.0 business artifact action registry")
    parser.add_argument("--station-chief-v22-agent-assignment-map", action="store_true", help="Attach v22.0 assignment map")
    parser.add_argument("--station-chief-v22-execution-plan", action="store_true", help="Attach v22.0 execution plan")
    parser.add_argument("--station-chief-v22-approved-business-workflow", action="store_true", help="Execute v22.0 controlled business workflow workpack")
    parser.add_argument("--station-chief-v22-approval-phrase", type=str, help="Human approval phrase for v22.0 business workflow")
    parser.add_argument("--station-chief-v22-operator-label", type=str, help="Metadata label for human operator")
    parser.add_argument("--station-chief-v22-workpack-label", type=str, help="Metadata label for business workpack")
    parser.add_argument("--station-chief-v22-client-label", type=str, help="Metadata label for business client")
    parser.add_argument("--station-chief-v22-business-workpack-receipt", action="store_true", help="Attach v22.0 workpack receipt")
    parser.add_argument("--station-chief-v22-business-workflow-audit", action="store_true", help="Attach v22.0 business workflow audit")
    ...
    parser.add_argument("--station-chief-v25-general-operator-schema", action="store_true", help="Print Station Chief v25.0 schema and exit")
    parser.add_argument("--station-chief-v25-general-operator", action="store_true", help="Attach Station Chief v25.0 bundle")
    parser.add_argument("--station-chief-v25-capability-registry", action="store_true", help="Attach Station Chief v25.0 capability registry")
    parser.add_argument("--station-chief-v25-task-type-registry", action="store_true", help="Attach Station Chief v25.0 task type registry")
    parser.add_argument("--station-chief-v25-command-menu", action="store_true", help="Attach Station Chief v25.0 command menu")
    parser.add_argument("--station-chief-v25-done-done-release-lock", action="store_true", help="Attach Station Chief v25.0 done-done release lock")
    parser.add_argument("--station-chief-v25-final-acceptance-report", action="store_true", help="Attach Station Chief v25.0 final acceptance report")
    parser.add_argument("--station-chief-v25-approved-operator-task", action="store_true", help="Execute Station Chief v25.0 approved operator task")
    parser.add_argument("--station-chief-v25-approval-phrase", type=str, help="Human approval phrase for v25 general operator runtime")
    parser.add_argument("--station-chief-v25-operator-task", type=str, help="Operator task text for v25 general operator runtime")
    parser.add_argument("--station-chief-v25-requested-task-type", type=str, help="Requested task type for v25 general operator runtime")
    parser.add_argument("--station-chief-v25-operator-label", type=str, help="Operator label for v25 general operator runtime")
    parser.add_argument("--station-chief-v25-workpack-label", type=str, help="Workpack label for v25 general operator runtime")
    ...
    parser.add_argument("--station-chief-v23-external-probe-plan", action="store_true", help="Attach v23.0 execution plan")
    parser.add_argument("--station-chief-v23-approved-external-web-probe", action="store_true", help="Execute v23.0 controlled external tool workpack")
    parser.add_argument("--station-chief-v23-approval-phrase", type=str, help="Human approval phrase for v23.0 external probe")
    parser.add_argument("--station-chief-v23-operator-label", type=str, help="Metadata label for human operator")
    parser.add_argument("--station-chief-v23-workpack-label", type=str, help="Metadata label for external tool workpack")
    parser.add_argument("--station-chief-v23-requested-url", type=str, help="Allowlisted URL for v23.0 external probe")
    parser.add_argument("--station-chief-v23-external-tool-receipt", action="store_true", help="Attach v23.0 workpack receipt")
    parser.add_argument("--station-chief-v23-external-tool-audit", action="store_true", help="Attach v23.0 external tool audit")
    ...
    if getattr(args, "station_chief_v25_general_operator_schema", False):
        print(json.dumps(create_station_chief_v25_general_operator_schema(), indent=2, ensure_ascii=False))
        return
    ...
    if getattr(args, "station_chief_v22_controlled_business_workflow_schema", False):
        print(json.dumps(create_station_chief_v22_controlled_business_workflow_schema(), indent=2, ensure_ascii=False))
        return
