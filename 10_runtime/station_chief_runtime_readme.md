...
- controlled worker hiring activation pilot manifest
...
python3 10_runtime/station_chief_runtime.py --command "check please" --controlled-worker-hiring-activation-pilot --pilot-confirm-token YES_I_APPROVE_CONTROLLED_WORKER_HIRING_ACTIVATION_PILOT --pilot-worker-limit 2 --pilot-worker-label pilot-worker-alpha --pilot-worker-label pilot-worker-beta
...
python3 10_runtime/station_chief_runtime.py --command "check please" --write-artifacts /tmp/station_chief_runs --registry-dir /tmp/station_chief_registry --controlled-worker-hiring-activation-pilot --pilot-confirm-token YES_I_APPROVE_CONTROLLED_WORKER_HIRING_ACTIVATION_PILOT
...
Next recommended step: build first supervised production dry-run.
