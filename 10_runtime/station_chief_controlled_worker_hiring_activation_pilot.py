...
CONTROLLED_WORKER_HIRING_ACTIVATION_PILOT_MODULE_VERSION = "3.3.0"
...
def generate_controlled_worker_hiring_activation_pilot_id(command: str, pilot_label: str, runtime_version: str = "3.3.0") -> str:
    ...
    return f"controlled-worker-hiring-activation-pilot-v3-3-{norm_label}-{digest}"

def create_controlled_worker_hiring_activation_pilot_schema() -> dict:
    return {
        "controlled_worker_hiring_activation_pilot_schema_version": "3.3.0",
...
def create_controlled_worker_hiring_activation_pilot_approval_gate(
    ...
    return {
        "controlled_worker_hiring_activation_pilot_approval_gate_version": "3.3.0",
...
def create_pilot_worker_limit_contract(
    ...
    return {
        "pilot_worker_limit_contract_version": "3.3.0",
...
def create_worker_identity_activation_contract(
    ...
    return {
        "worker_identity_activation_contract_version": "3.3.0",
        "contract_status": contract_status,
...
def create_task_assignment_denial_by_default(
    ...
    return {
        "task_assignment_denial_by_default_version": "3.3.0",
...
def create_human_supervised_pilot_gate(
    ...
    return {
        "human_supervised_pilot_gate_version": "3.3.0",
...
def create_pilot_rollback_abort_preview(
    ...
    return {
        "pilot_rollback_abort_preview_version": "3.3.0",
...
def create_pilot_audit_proof(
    ...
    return {
        "pilot_audit_proof_version": "3.3.0",
...
def create_pilot_readiness_summary(
    ...
    return {
        "pilot_readiness_summary_version": "3.3.0",
...
def create_first_supervised_production_dry_run_bridge(
    ...
    return {
        "first_supervised_production_dry_run_bridge_version": "3.3.0",
...
def create_controlled_worker_hiring_activation_pilot_bundle(
    ...
    return {
        "controlled_worker_hiring_activation_pilot_bundle_version": "3.3.0",
        "controlled_worker_hiring_activation_pilot_status": "CONTROLLED_WORKER_HIRING_ACTIVATION_PILOT_PREVIEW_ONLY",
