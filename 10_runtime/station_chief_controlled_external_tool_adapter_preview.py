...
CONTROLLED_EXTERNAL_TOOL_ADAPTER_PREVIEW_MODULE_VERSION = "3.3.0"
...
def generate_external_tool_preview_id(command: str, tool_label: str, runtime_version: str = "3.3.0") -> str:
    ...
    return f"external-tool-preview-v3-3-{normalized_tool_label}-{digest[:12]}"


def create_controlled_external_tool_adapter_preview_schema() -> dict:
    return {
        "controlled_external_tool_adapter_preview_schema_version": "3.3.0",
...
def create_external_tool_adapter_preview_approval_gate(
    ...
    return {
        "external_tool_adapter_preview_approval_gate_version": "3.3.0",
...
def create_external_tool_dry_run_adapter_registry(
    ...
    registry = {
        "external_tool_dry_run_adapter_registry_version": "3.3.0",
...
def create_per_tool_external_permission_gate(
    ...
    return {
        "per_tool_external_permission_gate_version": "3.3.0",
        "tool_id": tool_id,
...
def create_external_request_preview_contract(
    ...
    return {
        "external_request_preview_contract_version": "3.3.0",
        "tool_id": tool_id,
        "request_label": request_label,
...
def create_external_response_validation_schema() -> dict:
    return {
        "external_response_validation_schema_version": "3.3.0",
...
def create_external_response_validation_preview_result(
    ...
    if not response_preview_present:
        return {
            "external_response_validation_preview_result_version": "3.3.0",
...
def create_external_tool_abort_contract(
    ...
    return {
        "external_tool_abort_contract_version": "3.3.0",
...
def create_external_tool_audit_proof(
    ...
    proof = {
        "external_tool_audit_proof_version": "3.3.0",
...
def create_external_tool_preview_ledger(
    ...
    ledger = {
        "external_tool_preview_ledger_version": "3.3.0",
...
def create_external_tool_preview_readiness_summary(
    ...
    return {
        "external_tool_preview_readiness_summary_version": "3.3.0",
...
def create_permissioned_external_api_dry_run_preview_readiness_bridge(
    ...
    return {
        "permissioned_external_api_dry_run_preview_readiness_bridge_version": "3.3.0",
...
def create_controlled_external_tool_adapter_preview_bundle(
    ...
    bundle = {
        "controlled_external_tool_adapter_preview_bundle_version": "3.3.0",
