...
DEFAULT_V6_2_LANE_SCOPE_REFERENCE_LABEL = "station-chief-v6-2-lane-scope-reference"
DEFAULT_READINESS_REVIEW_LABEL = "station-chief-v6-3-readiness-review"
DEFAULT_READINESS_SCOPE_LABEL = "metadata-only-readiness-scope"
DEFAULT_READINESS_CONSTRAINT_LABEL = "metadata-only-readiness-constraints"
...
def generate_station_chief_v6_3_post_mvp_expansion_lane_readiness_id(
    command: str,
    v6_2_lane_scope_reference_label: str,
    readiness_review_label: str,
    readiness_scope_label: str,
    readiness_constraint_label: str,
    ...
    parts = [
        prefix,
        normalize_label(v6_2_lane_scope_reference_label, DEFAULT_V6_2_LANE_SCOPE_REFERENCE_LABEL),
        normalize_label(readiness_review_label, DEFAULT_READINESS_REVIEW_LABEL),
        normalize_label(readiness_scope_label, DEFAULT_READINESS_SCOPE_LABEL),
        normalize_label(readiness_constraint_label, DEFAULT_READINESS_CONSTRAINT_LABEL),
...
def create_station_chief_v6_3_post_mvp_expansion_lane_readiness_schema() -> dict:
    return {
        ...
        "readiness_packet_written": False,
        ...
        "v6_2_lane_scope_mutated": False,
        "v6_2_lane_scope_executed": False,
...
def create_readiness_approval_gate(
    v6_2_lane_scope_reference_label: str | None = None,
    readiness_review_label: str | None = None,
    readiness_scope_label: str | None = None,
    readiness_constraint_label: str | None = None,
    ...
    labels_present = bool(
        ...
        and readiness_review_label
        and readiness_scope_label
        and readiness_constraint_label
    ...
    return {
        ...
        "v6_2_lane_scope_reference_label": normalize_label(v6_2_lane_scope_reference_label, DEFAULT_V6_2_LANE_SCOPE_REFERENCE_LABEL) if v6_2_lane_scope_reference_label else None,
        "readiness_review_label": normalize_label(readiness_review_label, DEFAULT_READINESS_REVIEW_LABEL) if readiness_review_label else None,
        "readiness_scope_label": normalize_label(readiness_scope_label, DEFAULT_READINESS_SCOPE_LABEL) if readiness_scope_label else None,
        "readiness_constraint_label": normalize_label(readiness_constraint_label, DEFAULT_READINESS_CONSTRAINT_LABEL) if readiness_constraint_label else None,
        ...
        "v6_2_lane_scope_mutation_authorized": False,
        "v6_2_lane_scope_execution_authorized": False,
...
def create_v6_2_lane_scope_reference_contract(approval_gate: dict) -> dict:
    if not approval_gate.get("local_readiness_records_authorized"):
        return {
            "contract_created": False,
            "v6_2_lane_scope_reference_label": None,
            "v6_2_lane_scope_reference_label_normalized": None,
            "reference_is_metadata_only": False,
            "v6_2_lane_scope_mutated": False,
            "v6_2_lane_scope_executed": False,
            "v6_4_authorized": False,
        }
    raw_label = approval_gate.get("v6_2_lane_scope_reference_label", DEFAULT_V6_2_LANE_SCOPE_REFERENCE_LABEL)
    normalized = normalize_label(raw_label, DEFAULT_V6_2_LANE_SCOPE_REFERENCE_LABEL)
    return {
        "contract_created": True,
        "v6_2_lane_scope_reference_label": raw_label,
        "v6_2_lane_scope_reference_label_normalized": normalized,
...
def create_readiness_review_contract(approval_gate: dict) -> dict:
    if not approval_gate.get("local_readiness_records_authorized"):
        return {
            "contract_created": False,
            "readiness_review_label": None,
            "readiness_review_label_normalized": None,
            "review_is_metadata_only": False,
        }
    raw_label = approval_gate.get("readiness_review_label", DEFAULT_READINESS_REVIEW_LABEL)
    normalized = normalize_label(raw_label, DEFAULT_READINESS_REVIEW_LABEL)
    return {
        "contract_created": True,
        "readiness_review_label": raw_label,
        "readiness_review_label_normalized": normalized,
        "review_is_metadata_only": True,
        "review_does_not_implement_lane": True,
        "review_does_not_execute_lane": True,
        "review_does_not_start_workers": True,
        "review_does_not_create_queues": True,
        "review_does_not_execute_tasks": True,
        "review_does_not_call_apis_network_deployment_production": True,
    }


def create_readiness_scope_contract(approval_gate: dict) -> dict:
    if not approval_gate.get("local_readiness_records_authorized"):
        return {
            "contract_created": False,
            "readiness_scope_label": None,
            "readiness_scope_label_normalized": None,
            "scope_is_metadata_only": False,
            "scope_defines_readiness_boundaries_only": False,
        }
    raw_label = approval_gate.get("readiness_scope_label", DEFAULT_READINESS_SCOPE_LABEL)
    normalized = normalize_label(raw_label, DEFAULT_READINESS_SCOPE_LABEL)
    return {
        "contract_created": True,
        "readiness_scope_label": raw_label,
        "readiness_scope_label_normalized": normalized,
        "scope_is_metadata_only": True,
        "scope_defines_readiness_boundaries_only": True,
...
def create_readiness_constraint_contract(approval_gate: dict) -> dict:
    if not approval_gate.get("local_readiness_records_authorized"):
        return {
            "contract_created": False,
            "readiness_constraint_label": None,
            "readiness_constraint_label_normalized": None,
            "constraint_status": "BLOCKED",
        }
    raw_label = approval_gate.get("readiness_constraint_label", DEFAULT_READINESS_CONSTRAINT_LABEL)
    normalized = normalize_label(raw_label, DEFAULT_READINESS_CONSTRAINT_LABEL)
    ...
    return {
        "contract_created": True,
        "readiness_constraint_label": raw_label,
        "readiness_constraint_label_normalized": normalized,
...
def create_readiness_non_execution_boundary_contract(approval_gate: dict) -> dict:
    if not approval_gate.get("local_readiness_records_authorized"):
        return {
            "contract_created": False,
    ...
    raw_label = approval_gate.get("readiness_non_execution_boundary_label", DEFAULT_READINESS_NON_EXECUTION_BOUNDARY_LABEL)
    normalized = normalize_label(raw_label, DEFAULT_READINESS_NON_EXECUTION_BOUNDARY_LABEL)
    return {
        "contract_created": True,
        "readiness_non_execution_boundary_label": raw_label,
...
def build_readiness_packet_payload(
    approval_gate: dict,
    v6_2_lane_scope_reference_contract: dict,
    readiness_review_contract: dict,
    readiness_scope_contract: dict,
    readiness_constraint_contract: dict,
    readiness_non_execution_boundary_contract: dict,
    readiness_id: str,
) -> dict:
    payload = {
        "schema_version": "6.3.0",
        ...
        "readiness_type": "station_chief_v6_3_post_mvp_expansion_lane_readiness",
        "readiness_mode": "deterministic_local_post_mvp_expansion_lane_readiness_packet_only",
        "readiness_execution_type": "none_readiness_metadata_only",
        "v6_2_lane_scope_reference_label": approval_gate.get("v6_2_lane_scope_reference_label"),
        "readiness_review_label": approval_gate.get("readiness_review_label"),
        "readiness_scope_label": approval_gate.get("readiness_scope_label"),
        "readiness_constraint_label": approval_gate.get("readiness_constraint_label"),
        ...
        "readiness_message": "Station Chief v6.3 post-MVP expansion lane readiness wrote this deterministic local readiness packet. The v6.2 lane scope is referenced as metadata only. No worker was started and no task was executed.",
...
def create_readiness_packet_record(
    ...
    written = write_record.get("readiness_packet_written", False)
    ...
    return {
        ...
        "readiness_packet_written": write_record.get("readiness_packet_written", False),
...
def create_readiness_audit_record(
    ...
    dangerous_keys = [
        ...
        ("v6_2_lane_scope_mutated", readiness_packet_record),
        ("v6_2_lane_scope_executed", readiness_packet_record),
    ...
    return {
        ...
        "section_digests": {
            ...
            "v6_2_lane_scope_reference_contract": _digest(v6_2_lane_scope_reference_contract),
            "readiness_review_contract": _digest(readiness_review_contract),
            "readiness_scope_contract": _digest(readiness_scope_contract),
            "readiness_constraint_contract": _digest(readiness_constraint_contract),
            "readiness_non_execution_boundary_contract": _digest(readiness_non_execution_boundary_contract),
            "readiness_packet_record": _digest(readiness_packet_record),
        },
        "readiness_packet_written": readiness_packet_record.get("readiness_packet_written", False),
...
def create_readiness_summary(readiness_audit_record: dict) -> dict:
    ...
    return {
        ...
        "no_v6_2_lane_scope_mutation": True,
        "no_v6_2_lane_scope_execution": True,
...
def create_station_chief_v6_3_post_mvp_expansion_lane_readiness_bundle(
    ...
    approval_gate = create_readiness_approval_gate(
        v6_2_lane_scope_reference_label=v6_2_lane_scope_reference_label or DEFAULT_V6_2_LANE_SCOPE_REFERENCE_LABEL,
        readiness_review_label=readiness_review_label or DEFAULT_READINESS_REVIEW_LABEL,
        readiness_scope_label=readiness_scope_label or DEFAULT_READINESS_SCOPE_LABEL,
        readiness_constraint_label=readiness_constraint_label or DEFAULT_READINESS_CONSTRAINT_LABEL,
    ...
    v6_2_ref_contract = create_v6_2_lane_scope_reference_contract(approval_gate)
    review_contract = create_readiness_review_contract(approval_gate)
    scope_contract = create_readiness_scope_contract(approval_gate)
    constraint_contract = create_readiness_constraint_contract(approval_gate)
    non_exec_boundary = create_readiness_non_execution_boundary_contract(approval_gate)
    ...
    top_level = {
        ...
        "v6_2_lane_scope_reference_contract": v6_2_ref_contract,
        "readiness_review_contract": review_contract,
        "readiness_scope_contract": scope_contract,
        "readiness_constraint_contract": constraint_contract,
        "readiness_non_execution_boundary_contract": non_exec_boundary,
        ...
        "readiness_packet_written": write_record.get("readiness_packet_written", False) if write_record else False,
