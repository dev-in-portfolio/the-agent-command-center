...
def generate_external_api_dry_run_preview_id(command: str, api_label: str, runtime_version: str = "2.6.0") -> str:
    ...
    return f"external-api-dry-run-v2-6-{norm_label}-{digest}"

def create_permissioned_external_api_dry_run_preview_schema() -> dict:
    return {
        "permissioned_external_api_dry_run_preview_schema_version": "2.6.0",
...
def create_external_api_dry_run_approval_gate(
    ...
    return {
        "external_api_dry_run_approval_gate_version": "2.6.0",
        "api_label": api_label,
...
def create_api_endpoint_preview_registry(
    ...
    return {
        "api_endpoint_preview_registry_version": "2.6.0",
...
def create_request_envelope_validation(
    ...
    return {
        "request_envelope_validation_version": "2.6.0",
...
def create_credential_absence_proof(
    ...
    return {
        "credential_absence_proof_version": "2.6.0",
...
def create_outbound_call_prevention_proof(
    ...
    return {
        "outbound_call_prevention_proof_version": "2.6.0",
        "proof_status": proof_status,
...
def create_dry_run_response_fixture_contract(
    ...
    return {
        "dry_run_response_fixture_contract_version": "2.6.0",
        "endpoint_id": endpoint_id,
...
def create_external_api_audit_proof(
    ...
    return {
        "external_api_audit_proof_version": "2.6.0",
...
def create_external_api_dry_run_ledger(
    ...
    return {
        "external_api_dry_run_ledger_version": "2.6.0",
...
def create_external_api_dry_run_readiness_summary(
    ...
    return {
        "external_api_dry_run_readiness_summary_version": "2.6.0",
...
def create_controlled_multi_worker_audit_replay_preview_readiness_bridge(
    ...
    return {
        "controlled_multi_worker_audit_replay_preview_readiness_bridge_version": "2.6.0",
...
def create_permissioned_external_api_dry_run_preview_bundle(
    ...
    return {
        "permissioned_external_api_dry_run_preview_bundle_version": "2.6.0",
        "permissioned_external_api_dry_run_preview_status": "PERMISSIONED_EXTERNAL_API_DRY_RUN_PREVIEW_ONLY",
