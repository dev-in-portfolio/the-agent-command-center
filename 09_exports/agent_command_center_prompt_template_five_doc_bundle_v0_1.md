# Agent Command Center Prompt Template — Five-Document Bundle v0.1
...
## Purpose
Provide a reusable copy/paste template for creating exactly five non-runtime documentation files.
...
## Reusable Five-Document Bundle Prompt Template
```markdown
...
COMMIT:
git add [PATH1] [PATH2] [PATH3] [PATH4] [PATH5]
