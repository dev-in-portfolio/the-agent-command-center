...
const GROUP_READINESS_NOTE_CREATED = "GROUP_READINESS_NOTE_CREATED";
...
exports.handler = async function handler(event) {
  ...
  try {
    ...
    const result = await supabaseRpc("runtime_group_create_readiness_note", {
      p_scope: scope,
      p_lane_key: laneKey,
      p_agent_id: agentId,
    ...
    return jsonResponse(result.blocked ? 409 : 200, {
      ...
      operation: "create-group-readiness-note",
      blocked: Boolean(result.blocked),
      event_type: GROUP_READINESS_NOTE_CREATED,
    ...
    return jsonResponse(500, {
      ok: false,
      error: "Group readiness note creation failed.",
    });
  }
};
