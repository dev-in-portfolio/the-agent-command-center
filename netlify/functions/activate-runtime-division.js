  ...
  try {
    ...
    if (payload.activate_all === true) {
      return jsonResponse(400, {
        ok: false,
        error: "DIVISION_ACTIVATION_BLOCKED",
    ...
    if (chunkSize > 100) {
      return jsonResponse(400, {
        ok: false,
        error: "DIVISION_ACTIVATION_BLOCKED",
        message: "chunk_size exceeds 100. Full division activation must process in 10 chunks of 100.",
      });
    }
    ...
    return jsonResponse(result.blocked ? 409 : 200, {
      ...
      operation: "activate-runtime-division",
    ...
    return jsonResponse(500, { ok: false, error: "Runtime division activation failed." });
  }
};
