...
exports.handler = async function handler(event) {
  ...
  try {
    ...
    if (!result.ok) {
      return base.jsonResponse(result.blocked ? 409 : 400, { ok: false, operation: "activate-runtime-army-cohort", ...result }, "mvp62-20000-agent-department-gated-runtime-army");
    }

    return base.jsonResponse(200, {
      ok: true,
      operation: "activate-runtime-army-cohort",
      blocked: false,
    ...
    return base.jsonResponse(500, { ok: false, error: "Runtime army cohort activation failed." }, "mvp62-20000-agent-department-gated-runtime-army");
  }
};
