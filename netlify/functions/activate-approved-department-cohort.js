...
exports.handler = async function handler(event) {
  ...
  try {
    ...
    const result = await corps.supabaseRpc("activate_approved_department_cohort", {
    ...
    if (!result.ok) {
      return base.jsonResponse(result.blocked ? 409 : 400, {
        ok: false,
        operation: "activate-approved-department-cohort",
        ...result,
      }, "mvp61-5000-agent-department-gated-runtime-corps");
    }
    ...
    return base.jsonResponse(500, {
      ok: false,
      error: "Approved department cohort activation failed.",
    }, "mvp61-5000-agent-department-gated-runtime-corps");
  }
};
