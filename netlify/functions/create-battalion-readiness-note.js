...
const BATTALION_READINESS_NOTE_CREATED = "BATTALION_READINESS_NOTE_CREATED";
...
exports.handler = async function handler(event) {
  ...
  try {
    ...
    const result = await supabaseRpc("runtime_battalion_create_readiness_note", {
      p_scope: scope,
      p_lane_key: laneKey,
      p_agent_id: agentId,
    ...
    return jsonResponse(result.blocked ? 409 : 200, {
      ...
      operation: "create-battalion-readiness-note",
    ...
    return jsonResponse(500, {
      ok: false,
      error: "Battalion readiness note creation failed.",
    });
  }
};
